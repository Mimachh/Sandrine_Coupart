<x-admin-layout>
    <!-- Sidebar -->
    <div class="rounded-r-3xl fixed flex flex-col top-0 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
            ...
            <ul class="flex flex-col py-4 space-y-1">
                <li class="px-5 mb-4 hidden md:block">
                    <div class="flex flex-row items-center justify-center h-12 bg-blue-100 rounded-full">
                        <div class="text-center text-md font-semibold tracking-wide text-red-400 uppercase">Tableau de bord de <br> {{ auth()->user()->name }}</div>
                    </div>
                </li>
                ...
                <li>
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition class="pl-5">
                            <ul>
                                <li>
                                    <button wire:click="" type="button" class=" w-full relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
